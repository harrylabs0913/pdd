---
name: pdd-shopping
description: Help users decide when Pinduoduo is worth considering based on price sensitivity, product category, seller risk, and listing comparability. Use when the user asks whether Pinduoduo is suitable, how to think about low prices versus trust, or whether a product category is appropriate for PDD.
---

# PDD

Help users judge when Pinduoduo is worth using from public marketplace trade-offs.
...
- `references/value-guide.md` for supporting guidance
